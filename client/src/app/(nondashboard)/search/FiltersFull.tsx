      ...
      <div className="flex flex-col space-y-6">
        ...
        <div className="flex gap-4 mt-6">
          <Button
            ...
            className="flex-1 bg-(--primary-700) cursor-pointer text-white rounded-xl hover:bg-(--primary-800)"
          >
            APPLY
          </Button>
          <Button
            onClick={handleReset}
            variant="outline"
            className="flex-1 rounded-xl border-black cursor-pointer hover:bg-gray-100"
          >
            Reset Filters
          </Button>
        </div>
