...
export const api = createApi({
  ...
  reducerPath: "api",
  tagTypes: ["Tenants", "Managers", "Properties"],
  endpoints: (build) => ({
    getAuthUser: build.query<User, void>({
      queryFn: async (_, _queryApi, _extraOptions, fetchWithBQ) => {
        try {
          ...
          // if user does not exist, create new user TODO:
          if (
    ...
    updateTenantsSettings: build.mutation<
      Tenant,
    ...
    updateManagersSettings: build.mutation<
      Manager,
...
export const {
  useGetAuthUserQuery,
  useUpdateTenantsSettingsMutation,
  useUpdateManagersSettingsMutation,
